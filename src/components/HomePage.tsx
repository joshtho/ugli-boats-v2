      ...
      <div className="relative isolate ">
        ...
        >
          <div
            ...
            className="relative left-[calc(50%-11rem)] aspect-1155/678 w-144.5 -translate-x-1/2 rotate-30 bg-linear-to-tr from-[#252b0a] to-[#9eac07] opacity-30 sm:left-[calc(50%-30rem)] sm:w-288.75"
          />
        </div> */}
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-26">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              Learn more about us{' '}
              <Link to="/about">
                <span className="font-semibold text-[#414d0b]">
